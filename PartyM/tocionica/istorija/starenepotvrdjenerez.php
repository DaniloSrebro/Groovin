    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown" id="rez"><a href="#"><span>Istorija</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li><a class="nav-link" href="./potvrdjenerez.php">Potvrdjene Rezervacije</a></li>
           <li><a class="nav-link" href="#">Nepotvrđene Rezervacije</a></li>
...
$sql_select = "SELECT rez_id, ime, vrstarez, brojtelefona, brojstola, brojljudi, reservationstatus, zadatum, vremerez, mesto, vremedolaska, mestosedenja, sedenje, email FROM tocionicaistorija WHERE dosli='ne' ORDER BY zadatum desc";
...
if ($result->num_rows > 0) {
  ...
  echo "<p class='no-reservation'>Nema trenuthih rezervacija.</p>";
}
