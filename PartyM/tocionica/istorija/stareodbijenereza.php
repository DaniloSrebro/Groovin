...
$sql_select = "SELECT rez_id, ime, vrstarez, brojtelefona, brojstola, brojljudi, reservationstatus, zadatum, vremerez, mesto, vremedolaska, mestosedenja, sedenje, email FROM tocionicaodbijene";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo "<td class='column-ime'>" . $row["email"] . "</td>";
      ...
      echo "<td class='column-rezervacija-napravljena'>" . $row['vremerez'] . "</td>";
  ...
  echo "<p class='no-reservation'>Nema odbijenih rezervacija.</p>";
}
