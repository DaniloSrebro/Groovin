      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>";
          if ($row["reservationstatus"] == "approved") {
            echo '<span class="badge badge-pill badge-warning font-weight-normal">Approved</span>';
          } else {
