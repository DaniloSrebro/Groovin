...
<body>
  ...
  <br>
    ...
    <a href="#"><button class="button1" id="tomorrowBtn" style="background-color: #ffc506;">Tomorrow</button><br><p style="color:white; margin-left: 48%;"><?php echo $row_count_variable1; ?></p></a>
            ...
            <div>" . $time->format('H:i') . "</div>
                  ...
                  <div class='containersmesti' style='display: flex; align-items: center; gap: 10px;'>
                      ...
                      <div class='popuppromeni' style='display: none; font-size: 20px; color:black;'>
                          <form method='post' action='../akcije/podesi/1podesi.php'>
                          ...
                          <br>
                          <p>ili</p>
                          <form method='post' action='../akcije/vrati/1vrati.php'>
                              <input type='hidden' name='reservation_id' value='" . $row["id"] . "'>
