...
<body>
  ...
  <br>
    ...
    <a href="#"><button class="button1" id="day4Btn" style="background-color: #ffc506;">In 4 Days</button><br><p style="color:white; margin-left: 48%;"><?php echo $row_count_variable4; ?></p></a>
            ...
            <div>" . $time->format('H:i') . "</div>
                  ...
                  <div class='containersmesti' style='display: flex; align-items: center; gap: 10px;'>
                      ...
                      <div class='popuppromeni' style='display: none; font-size: 20px; color:black;'>
                          <form method='post' action='../akcije/podesi/4podesi.php'>
                          ...
                          <br>
                          <p>ili</p>
                          <form method='post' action='../akcije/vrati/4vrati.php'>
                              <input type='hidden' name='reservation_id' value='" . $row["id"] . "'>
