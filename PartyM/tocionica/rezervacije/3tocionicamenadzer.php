...
<body>
  ...
  <br>
    ...
    <a href="#"><button class="button1" id="day3Btn" style="background-color: rgba(133, 131, 131, 0.5); border: 2px solid #ccc; color: white; border-radius: 20px; cursor: pointer;">In 3 Days</button></a>
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <button onclick='ukljuciForm(this)' class='reject-button'><i class='bi bi-ban'></i></button>
          <div class='form-container-odbi' style='display: none;'>
              <form method='post' action='../akcije/odbij/3odbij.php'>
                ...
                <div class='containersmesti'>
                    ...
                    <div class='form-container' style='display: none;'>
                        <form method='post' action='../akcije/odobri/3odobri.php'>
                            <input type='hidden' name='reservation_id' value='" . $row["id"] . "'>
...
<div class="col">
    ...
    <?php
        ...
        $sql = "SELECT brojstola, vremedolaska FROM tocionica WHERE reservationstatus='approved' AND zadatum = DATE_ADD(CURDATE(), INTERVAL 3 DAY) ORDER BY vremedolaska asc";
...
function fetchReservations(tableNumber) {
    ...
    xhr.open('GET', '3fetch_reservations.php?table_number=' + tableNumber);
    xhr.onload = function() {
        if (xhr.status === 200) {
