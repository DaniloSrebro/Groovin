...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_update = "UPDATE tocionica SET brojstola = '$inputFieldValue' WHERE id = $reservation_id AND zadatum = DATE_ADD(CURDATE(), INTERVAL 3 DAY)" ; 
  
  if ($conn->query($sql_update) === TRUE) {
       
    $htmlPageUrl = "../../pregled/3pregledtocionica.php";
