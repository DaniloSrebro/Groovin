...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["reservation_id"])) {
    ...
    $sql_update = "UPDATE tocionica SET reservationstatus='pending' WHERE id = $reservation_id AND zadatum = DATE_ADD(CURDATE(), INTERVAL 4 DAY)";

    if ($conn->query($sql_update) === TRUE) {
        echo "Reservation rejected successfully";
        $htmlPageUrl = "../../pregled/4pregledtocionica.php";
