...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_update = "UPDATE tocionica SET brojstola = '$inputFieldValue', reservationstatus='approved' WHERE id = $reservation_id AND zadatum = DATE_ADD(CURDATE(), INTERVAL 1 DAY)" ; 
  
  if ($conn->query($sql_update) === TRUE) {
    $htmlPageUrl = "../../rezervacije/1tocionicamenadzer.php";
